...
namespace TENTAC_HRM.Models.MayChamCongModel
{
    internal class MayChamCongModel
    {
        ...
        public MayChamCongModel()
        {
        }

        public MayChamCongModel(string _MaMCC, string _TenMCC, int _IDMCC, string _KieuKetNoi, string _DiaChiIP, int _Port, int _CongCOM, string _TocDoTruyen, string _DiaChiWeb, DateTime _NgayDangKyTenMien, bool _SuDungWeb, string _Serial, string _SoDangKy, bool _TrangThai, int _TrangThaiMay)
        {
            MaMCC = _MaMCC;
            TenMCC = _TenMCC;
            IDMCC = _IDMCC;
