namespace TENTAC_HRM.Models.QuanLyNhanVienModel
{
    internal class ChucVuModel
    {
        ...
        public ChucVuModel(string _MaChucVu, string _MaCongTy, string _MaKhuVuc, string _TenKhuVuc, string _MaPhongBan, string _TenPhongBan, string _TenChucVu)
        {
            MaChucVu = _MaChucVu;
            MaCongTy = _MaCongTy;
            MaKhuVuc = _MaKhuVuc;
