...
namespace TENTAC_HRM.Forms.MayChamCong
{
    public partial class frm_TaiNhanVien : Form
    {
        ...
        private CommonModel _commonDTO = new CommonModel();
        private CommonKhuonMatBLL _commonKhuonMatBLL = new CommonKhuonMatBLL();
        private CommonKhuonMatModel _commonKhuonMatDTO = new CommonKhuonMatModel();
        ...
        private NhanVienUpdateModel _nhanVienUpdateDTO = new NhanVienUpdateModel();
