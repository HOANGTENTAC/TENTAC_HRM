...
namespace TENTAC_HRM.Custom
{
    ...
    public partial class MultiColumnComboPopup : Form
    {
        ...
        public void SetFullRow(int Row, string[] ItemValues)
        {
            if (IsValidRow(Row))
            {
                ...
                {
                    RJMessageBox.Show(this, "SetFullRow: Empty Values Sent", "Grid Error");
                }
            }
        }
        ...
        public void SetFullColumn(int Column, string[] ItemValues)
        {
            if (IsValidColumn(Column))
            {
                ...
                {
                    RJMessageBox.Show(this, "SetFullColumn: Empty Values Sent", "Grid Error");
                }
            }
        }
        ...
        public void AddItems(string[][] ItemValues)
        {
            ...
            {
                RJMessageBox.Show(this, "AddItems: Empty Values Sent", "Grid Error");
            }
        }
        ...
        private bool IsValidRowAndColumn(int Row, int Column)
        {
            if (Column < 0 || Row < 0)
            {
                RJMessageBox.Show(this, "Row or Column Cannot be Negative!", "Grid Error");
                return false;
            }
            else if (Row > lstvMyView.Items.Count)
            {
                RJMessageBox.Show(this, "SetCellValue: Row Out Of Range", "Grid Error");
                return false;
            }
            else if (Column > lstvMyView.Columns.Count)
            {
                RJMessageBox.Show(this, "SetCellValue: Column Out Of Range " + Column.ToString(), "Grid Error");
                return false;
            }
            else
            {
        ...
        private bool IsValidRow(int Row)
        {
            if (Row < 0)
            {
                RJMessageBox.Show(this, "Row Cannot be Negative!", "Grid Error");
                return false;
            }
            else if (Row > lstvMyView.Items.Count)
            {
                RJMessageBox.Show(this, "Row Out Of Range", "Grid Error");
                return false;
            }
            else
            {
        ...
        private bool IsValidColumn(int Column)
        {
            if (Column < 0)
            {
                RJMessageBox.Show(this, "Column Cannot be Negative!", "Grid Error");
                return false;
            }
            else if (Column > lstvMyView.Columns.Count)
            {
                RJMessageBox.Show(this, "Column Out Of Range " + Column.ToString(), "Grid Error");
                return false;
            }
            else
            {
